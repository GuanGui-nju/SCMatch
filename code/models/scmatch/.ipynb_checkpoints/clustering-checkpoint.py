...
############################################################
class Kmeans(object):
    def __init__(self, k, n_feat=64, device_id=0):
        self.k = k
        self.n_feat = n_feat
    ...
    def cluster(self, data, verbose=False):
        ...
        xb = preprocess_features(data, self.n_feat)

        # cluster the data
        I, loss = run_kmeans(xb, self.k, self.device_id, verbose)
...
def run_kmeans(x, nmb_clusters, device_id, verbose=False):
