...
from models.scmatch.scmatch import CatMatch
...
config_file = "./config/scmatch.yaml"
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    logger.info(f"             >> ClustFrom:{args.cluster_from_iter} ClustSimThr:{args.clust_cutoff}")
